...
*//*
        ...
        BufferedReader br = new BufferedReader(new FileReader("target/cupom.json"));
        Cupons cuponsJSON = new Gson().fromJson(br, Cupons.class);
        //this.mapCupons = cuponsJSON;


        */
/*InputStream inJson = Cupons.class.getResourceAsStream("target/cupom.json");
        Cupons cuponsJson = new ObjectMapper().readValue(inJson, Cupons.class);*//*
